...
class AppConstants {
  ...
  static const String appTagline = 'Plateforme de mise en relation';
  ...
  static const Color statusPublished = Color(0xFFDCEEFB);
  static const Color statusNegotiation = Color(0xFFFEF3C7);
  static const Color statusAssigned = Color(0xFFD1FAE5);
  static const Color statusInProgress = Color(0xFFFED7AA);
  static const Color statusCompleted = Color(0xFFA7F3D0);
    ...
    return ThemeData(
      ...
      inputDecorationTheme: InputDecorationTheme(
        ...
        focusedBorder: OutlineInputBorder(
          borderRadius: BorderRadius.circular(AppConstants.borderRadiusMedium),
          borderSide: BorderSide(color: AppConstants.primaryYellow, width: 2),
        ),
